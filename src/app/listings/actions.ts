...
const ListingInputSchema = z
  .object({
    ...
    ratePracticeOwnCarMin: optionalInt,
    ratePracticeOwnCarMax: optionalInt,
    rateHealthMin: optionalInt,
    rateHealthMax: optionalInt,
    hasOwnVehicle: z.coerce.boolean().optional(),
...
function parseFromForm(formData: FormData) {
  return ListingInputSchema.safeParse({
    ...
    ratePracticeOwnCarMin: formData.get("ratePracticeOwnCarMin"),
    ratePracticeOwnCarMax: formData.get("ratePracticeOwnCarMax"),
  ...
  try {
    await db.transaction(async (tx) => {
      await tx.insert(listings).values({
        ...
        ratePracticeOwnCarMin: data.ratePracticeOwnCarMin ?? null,
        ratePracticeOwnCarMax: data.ratePracticeOwnCarMax ?? null,
        rateHealthMin: data.rateHealthMin ?? null,
        rateHealthMax: data.rateHealthMax ?? null,
        hasOwnVehicle: data.hasOwnVehicle ? 1 : 0,
